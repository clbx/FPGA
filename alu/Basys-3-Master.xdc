...
set_property PACKAGE_PIN U1 [get_ports {C[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {C[1]}]
set_property PACKAGE_PIN T1 [get_ports {C[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {C[2]}]
set_property PACKAGE_PIN R2 [get_ports {C[3]}]				
...
##Pmod Header JB
##Sch name = JB1
#set_property PACKAGE_PIN A14 [get_ports {button[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {button[0]}]
##Sch name = JB2
#set_property PACKAGE_PIN A16 [get_ports {button[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {button[1]}]
##Sch name = JB3
#set_property PACKAGE_PIN B15 [get_ports {button[2]}]					
...
#Sch name = JC7
#set_property PACKAGE_PIN L17 [get_ports {bottom}]					
